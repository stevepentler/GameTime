...
function playerWins() {
  clearScoreAndRound();
  document.getElementById('game-status').innerHTML = 'Boy you musta been born on the bayou! You win';
  displayRound();
  resetRound();
}
...
function playerLoses() {
  clearScoreAndRound();
  document.getElementById('game-status').innerHTML = 'Shrimpin\' Ain\'t Easy! Try again';
  resetRound();
}
