...
function generateBullets(bullets) {
  ...
  console.log(generateFish(fishies));
  console.log(generateBullets(bullets));
  // console.log(fishPositions);



// var allFishies = fishies.forEach(function(fish) {fish} );
// var allBullets = bullets.forEach(function(bullet) {bullet} );
