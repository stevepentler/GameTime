...
function displayInstructions() {
  $('#instructions').html("<h4>" + "Instructions" + "</h4>" + 
                          ...
                          "<p>" + "Spacebar to drop nets on shrimp and collect points" + "</p>" +
                          "<p>" + "Pass Round 1 with 1500 points" + "</p>" + 
                          "<p>" + "Pass Round 2 with 2500 points" + "</p>" +
                          "<p>" + "Win the game with 3500 points!" + "</p>" +
                          "<p>" + "Hint: Shrimp closer to the bottom are worth more points" + "</p>" +
...
function playerWins() {
  ...
  $('#score-header').text("Previous Score");
  var wins = sessionStorage;
  $winningScores.prepend().html(wins[winsCounter]);
  clearScoreAndRound();
  displayRound();
  resetRound();
}
